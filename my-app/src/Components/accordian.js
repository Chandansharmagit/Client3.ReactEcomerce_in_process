                        ...
                        <div className="footer-content-column">
                            <div className="footer-logo">
                                <a className="footer-logo-link" >
                                    <span className="hidden-link-text">New Smart Furniture</span>
                                    <h1> New Smart Furniture Chandranigahapur Rautahat</h1>
                                </a>
                            </div>
                    ...
                    <div className="footer-copyright">
                        <div className="footer-copyright-wrapper">
                            <p className="footer-copyright-text">
                                <a className="footer-copyright-link"  target="_self"> ©2024. | Designed By: Chandan Sharma. |
